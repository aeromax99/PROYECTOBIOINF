...
#$ -l highp,h_rt=24:00:00,h_data=10G
#$ -pe shared 1
#$ -N AEROProyectofinal
#$ -cwd
#$ -m bea
#$ -o /u/scratch/d/dechavez/Bioinformatica-PUCE/HerrBio/AndresMU/OTRAVEZ/prueba2/prueba3/log/AeroProyecto.out
#$ -e /u/scratch/d/dechavez/Bioinformatica-PUCE/HerrBio/AndresMU/OTRAVEZ/prueba2/prueba3/log/AeroProyecto.err
#$ -M dechavezv
